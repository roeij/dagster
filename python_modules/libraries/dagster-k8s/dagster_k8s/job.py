...
class DagsterK8sJobConfig(
    ...
    def config_type_job(cls):
        ...
        container_context_config_type = DagsterK8sJobConfig.config_type_container_context().copy()

        # Some launchers and executors add this as `job_namespace` instead
        del container_context_config_type["namespace"]
