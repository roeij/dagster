...
```python file=/guides/dagster/asset_tutorial/test_complex_asset_graph.py startafter=start_asset_test endbefore=end_asset_test
ENOENT: no such file or directory, open '/Users/sryza/dagster/examples/docs_snippets/docs_snippets/guides/dagster/asset_tutorial/test_complex_asset_graph.py'
```
...
```python file=/guides/dagster/asset_tutorial/test_complex_asset_graph.py startafter=start_asset_group_test endbefore=end_asset_group_test
ENOENT: no such file or directory, open '/Users/sryza/dagster/examples/docs_snippets/docs_snippets/guides/dagster/asset_tutorial/test_complex_asset_graph.py'
```
